...
b : a ratio = Description from Williams et al. 2010 ‘…ratio calculated at excitation 310 nm from emission intensity at 380 nm (b region) divided by the emission intensity maximum observed between 420 and 435 nm (a region; Parlanti et al. 2000; Wilson and Xenopoulos 2009). The b : a ratio is used to access the relative contribution of recently produced DOM to highly degraded DOM (Wilson and Xenopoulos 2009). Higher fluorescence intensities in the b region have been associated with the rapid degradation or transformation of microbially derived, protein-like DOM, whereas fluorescence intensity in the a region is controlled by loading of more highly degraded humic-like compounds (Huguet et al. 2009; Wilson and Xenopoulos 2009). In incubation experiments containing labile DOM, the b : a ratio tends to decrease over longer time periods and as labile DOM is reduced (Parlanti et al. 2000; Wilson and Xenopoulos 2009). b : a values . 1 indicate that DOM is primarily of autochthonous origin and values , 0.6 indicate primarily allochthonous origin (Huguet et al. 2009).’​
