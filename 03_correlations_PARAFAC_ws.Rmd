...
## EEMs methods and indices

EEMS - The Excitation Emission Matrices (EEM) of fluorescence spectra of the samples in 1 cm quartz cuvettes were recorded using a three-dimensional fluorescence spectrophotometer (Aqualog; HORIBA Scientific, USA) at room temperature. The instrument scanned fluorescence intensity across emission wavelengths 300–560 nm at excitation wavelengths from 240 nm to 450 nm in a 1 cm quartz cuvette. Samples with DOC concentrations above 10 mg L−1 or values of absorbance at 254 nm greater than 0.3 abs m−1 on the absorbance spectrometer were diluted in ultrapure water (18.2 MΩ Milli-Q) prior to fluorescence analysis [Singh et al., 2013; Vodacek et al., 1997]  while all other samples were undiluted. EEMs were corrected for Aqualog-specific excitation and emission corrections in MATLAB (version R2022b) following the protocol outlined in Cory et al. (2010), including inner-filter effects, Raman scattering, Rayleigh-Tyndall scattering, and blank subtraction. The output in was generated in 1nm increments on both Ex and Em wavelengths. Subsequent functions were used to squeeze the EEM back to its original Ex and Em conformation and cut scattering effects out resulting in cleaned and cut matrices.

  From these matrices we calculated the Fluorescence Index, which is the ratio of emission intensity at 450 and at 500 measured at excitation wavelength of 370.

FI around 1.3: Indicates terrestrial (allochthonous) DOM, typically derived from soil and plant material. dominant terrestrial, higher-plant DOM source

FI around 1.8: Indicates microbial (autochthonous) DOM, typically produced within the aquatic environment. (McKnight et al., 2001)

From the matrices we calculated: 
Peak A – high value at this Excitation/Emission point (around 250 ex, 450 em) suggests greater concentration of terrestrial humic-like part (plant or animal decay). Characterized by high molecular weights, more stable form of carbon.

Peak C – These can indicate microbial humic compounds or terrestrial microbial processing of organic matter. Similar to peak A in that they tend to be more stable than ‘labile’ compounds but may be slightly less complex than Peak A compounds. 

Peak T – protein-like compounds, these can be considered part of the ‘labile’ pool, where they can be available for microbial breakdown/degradation and therefore have a faster turnover rate in the carbon cycle. 

The ratios of these 3 looks at the relative abundances of humic-like compounds to protein-like compounds. So, for example, a low A/T ratio indicates a dominance of protein-like materials vs humic compounds and should therefore be more labile. So, we might expect these to be low in studies that look at lakes with blooms or wastewater inputs. 

SUV254 – This is the ratio of absorbance of 254 nm normalized by the DOC concentration. This can be an indication of aromatic content, where aromatic compounds are typically derived from allochthonous or terrestrial plant material and soil. High values indicate reduced lability, where low values might mean a higher proportion of aliphatic compounds, that are more bioavailable to microorganisms. 
The Fluorescence Index: FI around 1.3: Indicates terrestrial (allochthonous) DOM, typically derived from soil and plant material. dominant terrestrial, higher-plant DOM source
FI around 1.8: Indicates microbial (autochthonous) DOM, typically produced within the aquatic environment. (McKnight et al., 2001)

HIX was calculated by dividing the integrated fluorescence intensity between 435 nm and 480 nm emission wavelengths with excitation at 254 nm by the integrated fluorescence intensity between 300 nm and 345 nm emission wavelengths with excitation at 254 nm. Larger HIX values are indicative of increasing humification and the presence of fulvic acids [Ohno, 2002; Zsolnay et al., 1999]. 
...
gg <- ggplot() +
  ...
  geom_line(data = filtered_hydro, aes(x = DATE, y = Q..cfs. / max(Q..cfs.) * max(fchydrograph2122$Q..cfs.)), 
