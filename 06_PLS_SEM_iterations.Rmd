...
indicators <- list(
  ...
  dom = c("PARAF_comp_3"),
  stage = c("baseflow", "lower_decreasing", "upper_decreasing", "increasing")
)
#"slope_mean",
...
## MODEL 1: Flow stage classifier as a latent variable. Total protein-like component  <br>
...
## MODEL 2: include a flow stage classifier as a latent variable where response is protein-like fraction of DOM.
...
Interpretation:
The response variable changes the details of the model. Now we see that stage has little effect on the fraction of protein-like DOM.
